function createModelWindow(pet = {}, headerM = "Добавить") {
  ...
  inputModal1.placeholder = "Имя котика";
  ...
  inputModal2.placeholder = "Ссылка на фото";
  ...
  inputModal3.placeholder = "Возраст котика";
  inputModal3.min = "0";
  inputModal3.max = "20";
  ...
  inputModal4.placeholder = "Рейтинг";
  inputModal4.min = "0";
  inputModal4.max = "5";
  ...
  labelModal5.innerText = "Любимец";
  labelModal5.setAttribute("for", inputModal5.id);
  formLineModal5.append(inputModal5, labelModal5);
  ...
  textAreaModal.placeholder = "Информация о питомце";
  ...
  saveBtnModal.append(spanSaveModal);
  ...
  if (headerM === "Редактирование") {
    inputModal1.value = pet.name;
    inputModal2.value = pet.image;
    if (pet.image !== "" && pet.image !== undefined) {
      prevTag.style.backgroundImage = `url(${pet.image})`;
    }
    inputModal3.value = pet.age;
    inputModal4.value = pet.rate;
    inputModal5.checked = pet.favorite;
    textAreaModal.value = pet.description;
